      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <div className={`w-3 h-3 border-2 border-brand-border ${isOnline ? 'bg-brand-tertiary animate-pulse' : 'bg-brand-error'}`}></div>
            <span className="text-xs font-headline font-black uppercase text-brand-text tracking-widest hidden sm:inline-block">
